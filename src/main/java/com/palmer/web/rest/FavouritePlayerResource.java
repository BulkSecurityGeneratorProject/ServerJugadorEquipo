...
import com.palmer.domain.User;
import com.palmer.domain.dto.EvolutionDTO;
import com.palmer.domain.dto.EvolutionGeneralJugDTO;
import com.palmer.domain.dto.PlayerDTO;
import com.palmer.repository.FavouritePlayerRepository;
import com.palmer.repository.PlayerRepository;
import com.palmer.repository.UserRepository;
import com.palmer.security.AuthoritiesConstants;
import com.palmer.security.SecurityUtils;
import com.palmer.service.FavouritePlayerService;
...
public class FavouritePlayerResource {
    ...
    public ResponseEntity<FavouritePlayer> createFavouritePlayer(@RequestBody FavouritePlayer favouritePlayer) throws URISyntaxException {
        ...
        if(favouriteExist == null){
            ...
            favouritePlayer.setFavouriteDateTime(ZonedDateTime.now());

            result = favouritePlayerService.save(favouritePlayer);
        }else{
            favouritePlayerService.delete(favouriteExist.getId());
            result = favouritePlayerService.save(new FavouritePlayer(ZonedDateTime.now(), user, favouritePlayer.getPlayer()));
        }
